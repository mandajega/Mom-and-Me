...
$sql_first_table = "SELECT foodType, AmountOfTimestried FROM nutritionfood WHERE user_id = ?";
                  ...
                  <div class="sug">
                    <h2>Food Log:</h2><br>
                     <ul id="log" style="font-size: 18px;"></ul>
                        ...
                        <tr>
                <th>Food Type</th>
                <th>Amount Of Times Tried</th>
            </tr>
            <?php while ($row = $result_first_table->fetch_assoc()) : ?>
                <tr>
                    <td><?php echo $row['foodType']; ?></td>
                    <td><center><?php echo $row['AmountOfTimestried']; ?></center></td>
                </tr>
            <?php endwhile; ?>
        </table>
    </div>
